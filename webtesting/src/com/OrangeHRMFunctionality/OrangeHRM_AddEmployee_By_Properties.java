...
public class OrangeHRM_AddEmployee_By_Properties {
...
WebElement login=driver.findElement(By.id(properties.getProperty("loginbutton")));
login.click();

String expected_HomePage="Admin";
//<a class="panelTrigger" id="welcome" href="#">Welcome Admin</a>
String actual_HomePage=driver.findElement(By.id(properties.getProperty("welcome"))).getText(); 
...
public void export_EmployeeId() throws IOException, InterruptedException
{
	...
	WebElement addEmployee_FirstName=driver.findElement(By.id(properties.getProperty("firstName")));
	addEmployee_FirstName.clear();
	addEmployee_FirstName.sendKeys(row.getCell(0).getStringCellValue());
	
	
	//<input class="formInputText" maxlength="30" type="text" name="middleName" id="middleName">
	WebElement addEmployee_MiddleName=driver.findElement(By.id(properties.getProperty("middleName")));
	...
	WebElement addEmployee_LastName=driver.findElement(By.id(properties.getProperty("lastName")));
	...
	WebElement addEmployee_Id=driver.findElement(By.id(properties.getProperty("employeeId")));
